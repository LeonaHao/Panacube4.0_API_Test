...
class getPrivNetList(unittest.TestCase):
    """获取云中心》网络管理》池网络列表信息"""
    @classmethod
    ...
    def getTest(self, tx):
        logger.info("****************获取池网络列表接口开始****************")
        headers ={'Content-Type':'application/json',
                  'Authorization': token
                   }
        reqUrl = networktUrl + '?external=false'
        caseNum = tx['test_num']
...
__generateTestCases(getPrivNetList, "getPrivNetList", "netMgtData.xlsx", "getPrivNetList")
