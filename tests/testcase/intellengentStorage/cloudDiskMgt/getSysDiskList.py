# -*- coding: utf-8 -*-
# @Time: 2021/12/06 14:09
# @Author: Leona
# @File: getSysDiskList.py
...
"""
获取智能存储》云硬盘管理》系统盘列表信息
"""


class getSysDiskList(unittest.TestCase):
    """获取智能存储》云硬盘管理》系统盘列表信息"""
    @classmethod
...
__generateTestCases(getSysDiskList, "getSysDiskList", "cloudDiskMagData.xlsx", "getSysDiskList")
