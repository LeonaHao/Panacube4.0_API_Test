# -*- coding: utf-8 -*-
# @Time: 2022/02/14 15:29
# @Author: Leona
# @File: startS3Service.py
...
class startS3Service(unittest.TestCase):
    """智能存储》服务管理》开启S3服务"""
    @classmethod
...
__generateTestCases(startS3Service, "startS3Service", "serviceMagData.xlsx", "startS3Service")
