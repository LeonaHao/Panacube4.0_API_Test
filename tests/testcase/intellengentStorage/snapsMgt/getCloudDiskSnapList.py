...
class getCloudDiskSnapList(unittest.TestCase):
    '''获取智能存储》快照管理》云组件快照列表'''
    @classmethod
...
__generateTestCases(getCloudDiskSnapList, "getCloudDiskSnapList", "snapsMagData.xlsx", "getCloudDiskSnapList")
