# -*- coding: utf-8 -*-
# @Time: 2021/12/10 14:29
# @Author: Leona
# @File: getPoolSnapList.py
...
class getPoolSnapList(unittest.TestCase):
    '''获取智能存储》快照管理》业务池快照列表'''
    @classmethod
...
__generateTestCases(getPoolSnapList, "getPoolSnapList", "snapsMagData.xlsx", "getPoolSnapList")
