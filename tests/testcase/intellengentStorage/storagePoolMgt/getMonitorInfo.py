# -*- coding: utf-8 -*-
# @Time: 2021/12/03 10:29
# @Author: Leona
# @File: getMonitorInfo.py

import unittest
import requests
import json
from configs.urlConfigs import storageMonitor,logoutUrl
...
class getMonitorInfo(unittest.TestCase):
...
__generateTestCases(getMonitorInfo, "getMonitorInfo", "storagePoolMagData.xlsx", "getMonitorInfo")
