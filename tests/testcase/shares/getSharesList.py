# -*- coding: utf-8 -*-
# @Time: 2022/01/19 16:09
# @Author: Leona
# @File: getSharesList.py
...
class getSharesList(unittest.TestCase):
    """获取智能存储》共享管理》共享列表信息"""
    @classmethod
...
__generateTestCases(getSharesList, "getSharesList", "sharesMagData.xlsx", "getSharesList")
